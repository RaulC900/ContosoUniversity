    ...
    public class InstructorController : Controller
    {
        ...
        public ActionResult Index(int? id, int? courseID)
        {
            ...
            if(courseID != null)
            {
                ...
                // Eager Loading
                var selectedCourse = db.Courses.Where(i => i.CourseID == courseID).Include(c => c.Enrollments).Single();
                foreach (Enrollment enrollment in selectedCourse.Enrollments)
                {
                    db.Enrollments.Where(e => e.EnrollmentID == enrollment.EnrollmentID).Include(e => e.Student).Single();
                }
                viewModel.Enrollments = selectedCourse.Enrollments;
